        ...
        await fetch(InsertAPIURL,
          ...
          .then((response) => {
            ...
            if (response[0].message === 'emailAlreadyExsist') {
              ...
              // setVisible('true')
              navigation.navigate('AfterLoginStack')
            }
  ...
  return (
    ...
    <SafeAreaView style={{
      ...
      <View style={{flexDirection:'column',marginHorizontal:'3%', justifyContent: "center" }}>
        ...
        <Text style={{marginVertical:"5%",alignSelf:'flex-end'}}>Forget Password?</Text>
        </TouchableOpacity>
      </View>
      <View style={{ flexDirection: 'column',justifyContent:'flex-end',marginBottom:20, height:height/3}}>

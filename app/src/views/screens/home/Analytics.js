...
import { TextInput, Text, Button, Snackbar ,Headline,TouchableRipple,DataTable } from 'react-native-paper';
...
setdisable(0)
  ...
  return (
      ...
      <View style={{marginTop:20,alignItems:'center',flexDirection:'row',justifyContent:'space-evenly'}}>
        <Image
